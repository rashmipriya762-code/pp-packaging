...
const navLinks: NavLink[] = [
  ...
  { label: "About Us", href: "/about" },
  {
    ...
    dropdown: [
      { label: "Paper Bags", href: "/bags-by-material/paper-bags" },
      { label: "Jute Bags", href: "/bags-by-material/jute-bags" },
      { label: "Cotton Bags", href: "/bags-by-material/cotton-bags" },
      { label: "Canvas Bags", href: "/bags-by-material/canvas-bags" },
      { label: "Non-Woven Bags", href: "/bags-by-material/non-woven-bags" },
      { label: "Organic & Eco-Friendly Bags", href: "/bags-by-material/organic-eco-friendly-bags" },
      { label: "Synthetic Bags", href: "/bags-by-material/synthetic-bags" },
      { label: "Tote Bags", href: "/bags-by-material/tote-bags" },
    ],
  },
  {
    ...
    dropdown: [
      { label: "Corporates", href: "/bags-by-industry/corporates" },
      { label: "Retail Stores & Brands", href: "/bags-by-industry/retail-stores-brands" },
      { label: "Sweet Industry", href: "/bags-by-industry/sweet-industry" },
      { label: "Cake Industry", href: "/bags-by-industry/cake-industry" },
      { label: "Restaurants & Cafes", href: "/bags-by-industry/restaurants-cafes" },
      { label: "Jewellers", href: "/bags-by-industry/jewellers" },
      { label: "Fashion Designers", href: "/bags-by-industry/fashion-designers" },
      { label: "Events", href: "/bags-by-industry/events" },
    ],
  },
  {
    label: "Boxes",
    href: "/boxes",
    dropdown: [
      { label: "Cardboard Boxes – 2 Layer", href: "/boxes/cardboard-boxes-2-layer" },
      { label: "Cardboard Boxes – 3 Layer", href: "/boxes/cardboard-boxes-3-layer" },
      { label: "Thermacol Boxes", href: "/boxes/thermacol-boxes" },
      { label: "Cake Boxes", href: "/boxes/cake-boxes" },
      { label: "Sweet Boxes", href: "/boxes/sweet-boxes" },
    ],
  },
  {
    label: "Our Clients",

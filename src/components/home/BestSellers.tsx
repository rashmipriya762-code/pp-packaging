      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="bg-[#F4ECE0] rounded-[2rem] md:rounded-[3rem] px-6 py-10 md:px-12 md:py-16 lg:px-16 lg:py-20 w-full overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <Link 
              href="/boxes" 
              className="px-6 py-2.5 rounded-full border border-[#0F292E] bg-transparent text-[#0F292E] hover:bg-[#0F292E] hover:text-white text-sm font-bold flex items-center transition-colors shrink-0"
            >

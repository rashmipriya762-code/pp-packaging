    ...
    <section className="bg-cream pt-3 pb-3 md:pt-4 md:pb-4">
      <div className="container-custom">
        <div className="flex flex-col lg:flex-row items-stretch">
          ...
          <div className="relative w-full lg:w-[42%] bg-teal-900 rounded-none rounded-tr-[2.5rem] rounded-bl-[2.5rem] p-10 md:p-12 overflow-hidden flex flex-col items-start justify-center z-10">
          ...
          {/* RIGHT CARD — Process */}
          <div className="w-full lg:w-[58%] bg-cream-soft rounded-xl p-10 md:p-12 flex flex-col justify-center">

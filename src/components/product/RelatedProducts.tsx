...
import { ALL_PRODUCTS, productHref } from "@/lib/content";
        ...
        <div className="flex items-end justify-between mb-10">
          ...
          <div className="hidden sm:flex items-center gap-2">
            <button
              ...
              className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-teal-900 border border-teal-900/10 shadow-sm hover:text-gold-600 transition-colors"
            >
            ...
            >
              <div className="relative aspect-[4/3] w-full bg-cream-soft overflow-hidden">
                <Image
                  ...
                  alt={product.name}
                  fill
                  sizes="(max-width: 1024px) 260px, 18vw"
